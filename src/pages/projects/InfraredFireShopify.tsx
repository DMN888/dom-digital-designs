    ...
    <main className="pt-6 pb-32">
      <div className="max-w-5xl mx-auto px-6">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-16">
          ...
          <div className="aspect-square w-full overflow-hidden rounded-2xl border border-[#333]">
            <img 
              src="https://i.imgur.com/oLasa4L.png" 
              alt="Gallery Image 2" 
              className="w-full h-full object-cover hover:scale-105 transition-transform duration-500"
            />
          </div>
          <div className="aspect-square w-full overflow-hidden rounded-2xl border border-[#333]">
            <img 
              src="https://i.imgur.com/v4QbIxn.png" 
              alt="Gallery Image 3" 
              className="w-full h-full object-cover hover:scale-105 transition-transform duration-500"
            />
          </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-12">
          <div className="md:col-span-2 space-y-8 text-[#a1a1aa] leading-relaxed">
            <div>
              ...
              <p className="mb-8">At Infrared Fire, I contribute to their online presence as a graphic designer, crafting various visual and written content. This includes designing the homepage banner, tracing and refining their logo, creating lifestyle images showcasing the benefits of saunas, and designing product listings for their diverse range of indoor and outdoor infrared saunas sourced from various brands. Additionally, I write and design thumbnails for informative articles, create engaging landing pages to promote specific products, and develop informative infographics and presentations to educate potential customers about the advantages of infrared saunas.</p>
              
              <h3 className="text-2xl font-bold text-white mb-4 mt-12">Hero Image</h3>
              <div className="grid grid-cols-1 gap-6">
                <div className="aspect-[5/2] w-full overflow-hidden rounded-2xl border border-[#333]">
                  <img src="https://i.imgur.com/AuVepWA.png" alt="Hero Image 1" className="w-full h-full object-cover hover:scale-105 transition-transform duration-500" />
                </div>
                <div className="aspect-[5/2] w-full overflow-hidden rounded-2xl border border-[#333]">
                  <img src="https://i.imgur.com/3S5G2q3.png" alt="Hero Image 2" className="w-full h-full object-cover hover:scale-105 transition-transform duration-500" />
                </div>
              </div>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                <div className="aspect-[16/9] w-full overflow-hidden rounded-2xl border border-[#333]">
                  <img src="https://i.imgur.com/G9sPkf6.png" alt="Article Thumbnail 1" className="w-full h-full object-cover hover:scale-105 transition-transform duration-500" />
                </div>
                <div className="aspect-[16/9] w-full overflow-hidden rounded-2xl border border-[#333]">
                  <img src="https://i.imgur.com/gmuRifA.png" alt="Article Thumbnail 2" className="w-full h-full object-cover hover:scale-105 transition-transform duration-500" />
                </div>
                <div className="aspect-[16/9] w-full overflow-hidden rounded-2xl border border-[#333]">
                  <img src="https://i.imgur.com/WMdQ4ob.png" alt="Article Thumbnail 3" className="w-full h-full object-cover hover:scale-105 transition-transform duration-500" />
                </div>
                <div className="aspect-[16/9] w-full overflow-hidden rounded-2xl border border-[#333]">
                  <img src="https://i.imgur.com/i9nnldr.png" alt="Article Thumbnail 4" className="w-full h-full object-cover hover:scale-105 transition-transform duration-500" />
                </div>
              </div>
            </div>
          </div>
